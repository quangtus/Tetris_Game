...
public class Board extends JPanel {
    ...
    private boolean showGhostPiece = false; // Biến để kiểm soát hiển thị khối bóng ma
    ...
    private void confirmRestart() {
        pause(); // Dừng trò chơi
        int option = JOptionPane.showConfirmDialog(this, "Bạn có muốn chơi lại không?", "Restart Game", JOptionPane.YES_NO_OPTION);
        if (option == JOptionPane.YES_OPTION) {
            restartGame();
        } else {
            pause(); // Tiếp tục trò chơi nếu người dùng chọn "No"
        }
    }
    ...
    private void drawGhostSquare(Graphics g, int x, int y) {
        // Giảm alpha từ 128 xuống 70 để tăng độ trong suốt
        g.setColor(new Color(128, 128, 128, 70)); // Màu xám với độ trong suốt cao hơn
        g.fillRect(x + 1, y + 1, squareWidth() - 2, squareHeight() - 2);
        g.setColor(new Color(192, 192, 192, 70)); // Màu xám sáng với độ trong suốt cao hơn
        g.drawLine(x, y + squareHeight() - 1, x, y);
        g.drawLine(x, y, x + squareWidth() - 1, y);
        g.setColor(new Color(64, 64, 64, 70)); // Màu xám tối với độ trong suốt cao hơn
        g.drawLine(x + 1, y + squareHeight() - 1,
                x + squareWidth() - 1, y + squareHeight() - 1);
        g.drawLine(x + squareWidth() - 1, y + squareHeight() - 1,
                x + squareWidth() - 1, y + 1);
    ...
    class TAdapter extends KeyAdapter {
        ...
        public void keyPressed(KeyEvent e) {
            ...
            switch (keycode) {
                ...
                case KeyEvent.VK_R -> confirmRestart(); // Thêm dòng này
